...
var routes = [
    { path: '', component: _components_main_menu_main_menu_component__WEBPACK_IMPORTED_MODULE_3__["MainMenuComponent"] },
    { path: 'ingame', component: _components_ingame_ingame_component__WEBPACK_IMPORTED_MODULE_4__["IngameComponent"] }
];
...
var Character = /** @class */ (function () {
    function Character(iddleAnim, attackAnim, health, coldDown, damage, height) {
    ...
    Character.prototype.GetIddle = function () {
    ...
    Character.ctorParameters = function () { return [
        { type: undefined },
        { type: undefined },
        { type: Number },
        { type: Number },
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _character__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./character */ "./src/app/classes/character.ts");


var PlayerCharacter = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](PlayerCharacter, _super);
    function PlayerCharacter() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PlayerCharacter.prototype.IsPlayer = function () {
        return true;
    };
...
var CharacterComponent = /** @class */ (function () {
    ...
    CharacterComponent.prototype.ngOnInit = function () {
        ...
        setInterval(function () {
            _this.mainAnim.PlayAnimation(_this.charInfo.GetAttack());
        }, 5000);
    };
...
var IngameComponent = /** @class */ (function () {
    ...
    IngameComponent.prototype.ngOnInit = function () {
        ...
        setTimeout(function () {
            _this.enemies.push(new src_app_classes_character__WEBPACK_IMPORTED_MODULE_4__["Character"]({
                name: "wolfIddle",
                length: 12,
                speed: 100,
                play: _interfaces_animation_info_anim__WEBPACK_IMPORTED_MODULE_2__["EnumAnim"].loop
    ...
    IngameComponent.prototype.gridMonster = function (index) {
...
var SpriteAnimComponent = /** @class */ (function () {
    function SpriteAnimComponent() {
        this.indexFrame = 0;
    }
    SpriteAnimComponent.prototype.ngOnInit = function () {
        this.PlayAnimation(this.defaultAnim);
    };
    SpriteAnimComponent.prototype.ngOnDestroy = function () {
        this.ClearAnimInterval();
    };
    SpriteAnimComponent.prototype.SetDefaultAnimation = function (newAnim) {
        this.defaultAnim = Object.create(newAnim);
    };
    SpriteAnimComponent.prototype.PlayAnimation = function (newAnim) {
        this.currentAnim = Object.create(newAnim);
        this.SetCurrentFrames(newAnim);
        this.PlayCurrentAnim();
    };
    SpriteAnimComponent.prototype.SetCurrentFrames = function (info) {
        this.currentFrames = [];
        for (var i = 1; i <= info.length; i++) {
            this.currentFrames.push("assets/sprites/" + info.name + "/" + info.name + "_(" + i + ")" + ".png");
        }
    };
    SpriteAnimComponent.prototype.PlayCurrentAnim = function () {
        var _this = this;
        this.ClearAnimInterval();
        this.indexFrame = 0;
        this.currentFrame = this.currentFrames[this.indexFrame];
        this.currentInterval = setInterval(function () { _this.AnimInterval(); }, this.currentAnim.speed);
    };
    SpriteAnimComponent.prototype.AnimInterval = function () {
        this.indexFrame++;
    ...
    SpriteAnimComponent.prototype.ClearAnimInterval = function () {
